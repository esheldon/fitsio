...
class TableHDU(HDUBase):
    ...
    def __init__(self, fits, ext, **keys):
        ...
        self.align=keys.get('align',False)
    ...
    def _read_align_fixed(self, array, all_colnumsp, col_indices, rows):
        """
    ...
    def _read_align_var(self, array, all_colnumsp, col_indices, rows):
        """
    ...
    def read_slice(self, firstrow, lastrow, step=1, **keys):
        ...
        if self.align:
            keys['rows'] = numpy.arange(firstrow, lastrow, step, dtype='i8')
            return self.read(**keys)
    ...
    def get_rec_dtype(self, **keys):
        ...
        for i,colnum in enumerate(colnums):
            ...
            descr.append(dt)
            isvararray[i] = isvar
        dtype=numpy.dtype(descr,align=self.align)
